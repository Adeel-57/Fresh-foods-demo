...
const Cart_icon = ({ size, active }) => {


  return (
    <>
      {
        active.cart ? <Link to={'/'} className='cart'><svg width={size} height={size} viewBox="3 2 18 20" >
        ...
        </svg></Link> : <Link to={'/cart'} className='cart'><svg width={size} height={size} viewBox="3 2 18 20" >
